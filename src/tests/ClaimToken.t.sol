...
contract ERC20Test is DSSTest {
    ...
    function invariantMetadata() public {
        assertEq(token.name(), "Maker Global Settlement Claim");
        assertEq(token.symbol(), "CLAIM");
    ...
    function testDecreaseAllowanceInsufficientBalance() public {
        assertTrue(token.increaseAllowance(address(0xBEEF), 1e18));
        vm.expectRevert("ClaimToken/insufficient-allowance");
    ...
    function testTransferInsufficientBalance() public {
        ...
        vm.expectRevert("ClaimToken/insufficient-balance");
    ...
    function testPermitPastDeadline() public {
        ...
        vm.expectRevert("ClaimToken/permit-expired");
